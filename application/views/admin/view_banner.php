                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php
								   ...
								   foreach($gallery as $row): ?>
                                    <tr class="odd gradeX">
                                <td> <img  src="<?= base_url() ?>uploads/banner/<?= $row['image']; ?>" style="width: 150px; height: 150px;" ></td>
                                        <td align="center" >
										 <!--<a href="edit_banner/<?= $row['id']; ?>" class="glyphicon glyphicon-eye-open"></a>-->
										 <a href="delete_banner/<?= $row['id']; ?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a></td>
                                    </tr>
									<?php
									$k++;
									endforeach; ?>
